...
public class TestFinance {
	...
	public void TestPVandPMT(){
		...
		int iYearsRetired = 20;
		double dAnnualReturnRetired = 0.02;
		int dRequiredIncome = 10000;
		int dMonthlySSI = 2642;
		
		
		Retirement retireTest= new Retirement(iYearsToWork, dAnnualReturnWorking, iYearsRetired, dAnnualReturnRetired, dRequiredIncome,dMonthlySSI);
		
		assertEquals(554.13,retireTest.MonthlySavings(),0.01);
		assertEquals(1454485.55,Math.abs(retireTest.TotalAmountToSave()),0.01);
